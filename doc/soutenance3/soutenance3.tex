...
%%% TODO : Prototype Spawn / Audio.Play
...
Cette variable va servir à trouver la distance au centre du pixel. Seulement, je voudrais une position normalisée, c'est à dire comprise entre 0 (le point est au centre) et 1 (le point est sur un des quatre coins). Comme nous sommes en coordonnées UV, une diagonale possède une longueur de
%%% TODO : Math symbol + remettre sur ligne
sqrt(2).
Nous pouvons mettre à l'echelle le vecteur position en doublant sa longueur pour avoir une distance maximale de
%%% TODO : Math symbol + remettre sur ligne
sqrt(2)
puis diviser par sqrt(2) le résultat.
