...
Pour contrôler le joueur, il suffit d'appuyer sur les touches que vous avez enregistrées (ou WASD par défaut) pour les mouvements horizontaux ou espaces pour sauter, concernant la caméra, la souris est utilisée. Nous pouvons également attaquer d'autres joueurs en appuyant sur le bouton gauche de la souris et en ayant un joueur devant nous.
...
Pour connaître son propre statut, nous pouvons regarder en haut à gauche de l'écran, notre nom est affiché avec la même couleur que celle de notre statue.
...
Je me suis occupé d'implémenter les sons et musiques au sein du jeu. Léandre s'est occupé de composer les musiques et pour ma part je les ai mixées et intégrées au jeu. Les éléments sonores composés sont l'intégralité des musiques ainsi que certains effets tels que ceux de victoire ou de défaite.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Lumières.png}
